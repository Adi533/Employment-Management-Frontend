...
const ApproveLeave = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await axios.get("https://employment-management-backend.onrender.com/api/leaves/applied-leave/");
  ...
  const leaveApproval = async (permission, leaveId) => {
    try {
      await axios.patch(`https://employment-management-backend.onrender.com/api/leaves/approve-leave/${leaveId}`, {
